...
featuredImg: ../images/projects/pop-pouf-60/pop-pouf-60-featured.jpg
...
The project was entirely created using the open source software Blender. Materials were created proceduraly using Blender's node based shader editor.

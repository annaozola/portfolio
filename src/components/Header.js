      ...
      <div className="header__aboutwrapper">
        <div className="grid">
          <div className="header__aboutwrapper__about">
            ...
            >
              <p>
                I'm Anna - a versatile digital designer and web developer, born
                and raised in Riga, Latvia. I spend a lot of my free time
                expanding my design and development knowledge. Recently, I have
                realized that I am very passionate about 3D CGI and VFX so I
                tend to work on 3D CGI projects whenever I can.
              </p>
            </motion.div>
